...
\end{equation}
All the distributions methioned so far are part of the Exponential Family. Distributions in the exponental family always have a conjugate priors, however they may not always be standard, well-known distributions. %TODO CITE
