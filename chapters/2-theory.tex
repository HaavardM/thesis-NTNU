...
\subsection{Softmax}
The softmax is a useful transformation from $\mathcal{R}^N$ to $\{\mathbf{x} \in (0,1)^N | \sum x_i = 1\}$. It can be viewed as a multivariate generalization of the sigmoid function. 
