...
Variational Inference then boils down to finding the best surrogate density $q^*(\mathbf{x})$ which maximize \acrshort{elbo}, or equivalently minimize \acrshort{kl} \cite{Blei_2017}.
