...
An extension to \acrshort{hmc}, the \textit{\acrfull{nuts}} is proposed in \cite{hoffman2011nouturn}. It eliminates the need for manual tuning of leapfrog steps and it is shown empirically to perform comparably to well tuned \acrshort{hmc} method without any manual intervention.
